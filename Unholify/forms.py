...
class SelectForm(FlaskForm):
    ...
    #type_choices=[('A','I am older than 21 years'),('B','I am not yet 21')]
    #type = SelectField('Let us know something about your age',choices=type_choices,validators=[Required()])
